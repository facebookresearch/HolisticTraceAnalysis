...
class ParserConfig:
    ...
    ARGS_CUDA_THREADS: List[AttributeSpec] = [
        ...
        AttributeSpec("registers_per_thread", "registers_per_thread", ValueType.Int, -1),
    ]
    ...
    ARGS_SYNC:  List[AttributeSpec] = [
        ...
        AttributeSpec("wait_on_cuda_event_record_corr_id", "wait_on_cuda_event_record_corr_id", ValueType.Int, -1),
    ]
    ...
    def get_default_args(cls) -> List[AttributeSpec]:
        return cls.ARGS_CUDA_MINIMUM + cls.ARGS_INPUT_SHAPE + cls.ARGS_SYNC + cls.ARGS_BANDWIDTH
